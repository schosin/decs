...
/**
 * Annotation that can be used on abstract methods to add or remove components from entities.
 ...
 * Component types set in {@link #remove()} will be removed.
 * Component types set in {@link #remove()} must not be used as a parameter and vise-versa.
 * Passed components must not be null.
 * Passed components will be added to the entity, overriding existing components.
 * 
 * <p>
 * Methods must have {@code void} as a return type.
 * 
 * <p>
 * <b>Attention:</B>
...
public @interface Transmute {
    ...
    /**
     * Components to remove when the transmute method is invoked.
     */
