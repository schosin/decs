...
public sealed interface UtilityMethod extends EcsMethod {
    ...
    static UtilityMethod readMetadata(BufferedReader reader, AbstractGenerator generator) throws IOException {
        ...
        return switch (type) {
            ...
            default -> throw new IllegalArgumentException("Unknown utility method type '%s'. Perform a clean build.".formatted(type));
        };
    }
    ...
    record ArchetypeMethod(ExecutableElement method, ExecutableElement initializer, String methodName,
            String initializerName, boolean returnsEntityRefs, List<Parameter> parameters, List<ComponentParameter> enumComponents,
    ...
    record TransmuteMethod(ExecutableElement method, ExecutableElement initializer, String methodName,
            String initializerName, List<Parameter> parameters, List<ComponentParameter> enumComponents,
            List<ComponentParameter> components, List<TypeName> remove) implements UtilityMethod {
        ...
        static TransmuteMethod readMetadata(BufferedReader reader) throws IOException {
            ...
            return new TransmuteMethod(null, null, methodName, initializerName, parameters, enumComponents, components, remove);
        }
     ...
     */
    record CountMethod(ExecutableElement method, String methodName, CompositionData composition) implements UtilityMethod {
