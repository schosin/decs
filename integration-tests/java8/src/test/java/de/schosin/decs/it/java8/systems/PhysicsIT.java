package de.schosin.decs.it.java8.systems;
...
public class PhysicsIT extends AbstractIntegrationTest {
    ...
    void testSystem() {
        // Setup
        InternalWorld world = (InternalWorld) World.builder()
                .add(TestSystem.class)
                .build();

        TestArchetype archetype = world.getUtility(TestArchetype.class);
        ...
        // Verify
        TestSystem system = world.getSystem(TestSystem.class);
